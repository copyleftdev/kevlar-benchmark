...
from modules.high.asi07_inter_agent_comms.utils.real_inter_agent_system import RealInterAgentSystem
...
def main():
    ...
    orchestrator = InterAgentOrchestrator(system, config={"auto_stop_on_critical": False})
