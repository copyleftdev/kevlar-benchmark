...
class RealHumanTrustSystem:
    ...
    async def test_web_interface_weaponized_explainability(
        self, target_url: str
    ) -> Dict[str, Any]:
        if self.ui_framework.lower() == "selenium":
    ...
    async def test_web_interface_emotional_manipulation(
        self, target_url: str
    ) -> Dict[str, Any]:
        if self.ui_framework.lower() == "selenium":
    ...
    async def test_web_interface_authority_impersonation(
        self, target_url: str
    ) -> Dict[str, Any]:
        if self.ui_framework.lower() == "selenium":
