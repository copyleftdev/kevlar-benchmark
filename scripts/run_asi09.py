...
from modules.medium.asi09_human_trust.utils.real_human_trust_system import (
    RealHumanTrustSystem,
)
...
async def main():
    ...
    BROWSER_TYPE = (
        "chromium"  #  "firefox", "webkit" (Playwright) / "chrome", "firefox" (Selenium)
    )
